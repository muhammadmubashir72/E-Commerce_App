...
class ShopScreen9 extends StatefulWidget {  
  const ShopScreen9({super.key});

  @override
  State<ShopScreen9> createState() => _ShopScreen9State();
}

class _ShopScreen9State extends State<ShopScreen9> {
  void initState() {
    getCateory();
    super.initState();
  }
