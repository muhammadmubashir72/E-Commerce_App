...
class ShopScreen7 extends StatefulWidget {  
  const ShopScreen7({super.key});

  @override
  State<ShopScreen7> createState() => _ShopScreen7State();
}

class _ShopScreen7State extends State<ShopScreen7> {
  void initState() {
    getCateory();
    super.initState();
  }
