...
class ShopScreen6 extends StatefulWidget {  
  const ShopScreen6({super.key});

  @override
  State<ShopScreen6> createState() => _ShopScreen6State();
}

class _ShopScreen6State extends State<ShopScreen6> {
  void initState() {
    getCateory();
    super.initState();
  }
