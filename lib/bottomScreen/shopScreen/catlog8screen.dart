...
class ShopScreen8 extends StatefulWidget {  
  const ShopScreen8({super.key});

  @override
  State<ShopScreen8> createState() => _ShopScreen8State();
}

class _ShopScreen8State extends State<ShopScreen8> {
  void initState() {
    getCateory();
    super.initState();
  }
