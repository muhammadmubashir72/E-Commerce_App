...
class ShopScreen10 extends StatefulWidget {  
  const ShopScreen10({super.key});

  @override
  State<ShopScreen10> createState() => _ShopScreen10State();
}

class _ShopScreen10State extends State<ShopScreen10> {
  void initState() {
    getCateory();
    super.initState();
  }
